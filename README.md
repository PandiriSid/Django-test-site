The tools and technologies involved are  : Python, Django Framework, SQL server for the DB, Html, CSS, JS, Data: is all University Internal data saved in the DB
